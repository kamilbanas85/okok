...
start_train_date_list = [start_date, '2022-01-01', '2026-01-01']
...
start_train_date = start_train_date_list[1]  # or start_train_date_list[1] for the second option
...
# val set
val_start = test_set_date - pd.DateOffset(months=1)
...
param_tft= {
    ...
    "output_chunk_length": 24,   # REQUIRED for TFT
    "hidden_size": 40,          # replaces hidden_dim
    "lstm_layers": 2,           # replaces n_rnn_layers
    "num_attention_heads": 4,   # new (TFT-specific)
    "dropout": 0.1,
    "batch_size": 70,
    "n_epochs": 80,
}
...
param_tft_full = param_tft.copy()
param_tft_full['n_epochs'] = tft_model.epochs_trained
#param_tft_full['n_epochs'] = 15
# define full model
...
# predict test set
yhat_test_sld = tft_model_full.predict(
